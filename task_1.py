...
res = add_mul(float(input()), float(input()))
print(res)
...
res = div_int_rem(float(input()), float(input()))
print(res)
...
res = xor_swap(int(input()), int(input()))
print(res)
...
res = min_conditional(float(input()), float(input()))
...
r = exponentiation(float(input()), float(input()), float(input()))
print(r)
...
value = check_32_even_bit_set(2)
print(f'{value} in binary is {bin(value)}')
print(value)
